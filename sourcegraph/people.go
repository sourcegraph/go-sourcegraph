...
type PeopleService interface {
	...
	// List people.
	List(opt *PersonListOptions) ([]*User, Response, error)
...
type Person struct {
	*User
	...
	Stat PersonStats `json:",omitempty"`
}
...
func (s *peopleService) List(opt *PersonListOptions) ([]*User, Response, error) {
...
type MockPeopleService struct {
	...
	List_                  func(opt *PersonListOptions) ([]*User, Response, error)
...
func (s MockPeopleService) List(opt *PersonListOptions) ([]*User, Response, error) {
	return s.List_(opt)
}
