...
func (s *ReposClient) Delete(ctx context.Context, in *sourcegraph.RepoSpec, opts ...grpc.CallOption) (*pbtypes1.Void, error) {
...
func (s *ReposServer) Delete(v0 context.Context, v1 *sourcegraph.RepoSpec) (*pbtypes1.Void, error) {
...
type UserAuthClient struct {
	...
	CheckLoginCredentials_ func(ctx context.Context, in *sourcegraph.LoginCredentials) (*sourcegraph.AuthenticatedUser, error)
...
func (s *UserAuthClient) CheckLoginCredentials(ctx context.Context, in *sourcegraph.LoginCredentials, opts ...grpc.CallOption) (*sourcegraph.AuthenticatedUser, error) {
	return s.CheckLoginCredentials_(ctx, in)
}
...
type UserAuthServer struct {
	...
	CheckLoginCredentials_ func(v0 context.Context, v1 *sourcegraph.LoginCredentials) (*sourcegraph.AuthenticatedUser, error)
...
func (s *UserAuthServer) CheckLoginCredentials(v0 context.Context, v1 *sourcegraph.LoginCredentials) (*sourcegraph.AuthenticatedUser, error) {
	return s.CheckLoginCredentials_(v0, v1)
}
...
type RegisteredClientsClient struct {
	...
	GetCurrent_ func(ctx context.Context, in *pbtypes1.Void) (*sourcegraph.RegisteredClient, error)
	Create_     func(ctx context.Context, in *sourcegraph.RegisteredClient) (*sourcegraph.RegisteredClientCredentials, error)
	Update_     func(ctx context.Context, in *sourcegraph.RegisteredClient) (*pbtypes1.Void, error)
	Delete_     func(ctx context.Context, in *sourcegraph.RegisteredClientSpec) (*pbtypes1.Void, error)
...
func (s *RegisteredClientsClient) GetCurrent(ctx context.Context, in *pbtypes1.Void, opts ...grpc.CallOption) (*sourcegraph.RegisteredClient, error) {
	return s.GetCurrent_(ctx, in)
}

func (s *RegisteredClientsClient) Create(ctx context.Context, in *sourcegraph.RegisteredClient, opts ...grpc.CallOption) (*sourcegraph.RegisteredClientCredentials, error) {
	return s.Create_(ctx, in)
}

func (s *RegisteredClientsClient) Update(ctx context.Context, in *sourcegraph.RegisteredClient, opts ...grpc.CallOption) (*pbtypes1.Void, error) {
	return s.Update_(ctx, in)
}

func (s *RegisteredClientsClient) Delete(ctx context.Context, in *sourcegraph.RegisteredClientSpec, opts ...grpc.CallOption) (*pbtypes1.Void, error) {
	return s.Delete_(ctx, in)
}
...
type RegisteredClientsServer struct {
	...
	GetCurrent_ func(v0 context.Context, v1 *pbtypes1.Void) (*sourcegraph.RegisteredClient, error)
	Create_     func(v0 context.Context, v1 *sourcegraph.RegisteredClient) (*sourcegraph.RegisteredClientCredentials, error)
	Update_     func(v0 context.Context, v1 *sourcegraph.RegisteredClient) (*pbtypes1.Void, error)
	Delete_     func(v0 context.Context, v1 *sourcegraph.RegisteredClientSpec) (*pbtypes1.Void, error)
...
func (s *RegisteredClientsServer) GetCurrent(v0 context.Context, v1 *pbtypes1.Void) (*sourcegraph.RegisteredClient, error) {
	return s.GetCurrent_(v0, v1)
}

func (s *RegisteredClientsServer) Create(v0 context.Context, v1 *sourcegraph.RegisteredClient) (*sourcegraph.RegisteredClientCredentials, error) {
	return s.Create_(v0, v1)
}

func (s *RegisteredClientsServer) Update(v0 context.Context, v1 *sourcegraph.RegisteredClient) (*pbtypes1.Void, error) {
	return s.Update_(v0, v1)
}

func (s *RegisteredClientsServer) Delete(v0 context.Context, v1 *sourcegraph.RegisteredClientSpec) (*pbtypes1.Void, error) {
	return s.Delete_(v0, v1)
}
