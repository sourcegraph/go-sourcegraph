...
type ReposService interface {
	...
	GetCombinedStatus(spec RepoRevSpec, opt *ListOptions) (*CombinedStatus, Response, error)
...
type MockReposService struct {
	...
	GetCombinedStatus_ func(spec RepoRevSpec, opt *ListOptions) (*CombinedStatus, Response, error)
...
func (s MockReposService) GetCombinedStatus(spec RepoRevSpec, opt *ListOptions) (*CombinedStatus, Response, error) {
