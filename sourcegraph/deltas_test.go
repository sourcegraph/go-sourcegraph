...
var (
	baseRev = RepoRevSpec{RepoSpec: RepoSpec{URI: "src:///base/repo"}, Rev: "baserev", CommitID: baseCommit}
	headRev = RepoRevSpec{RepoSpec: RepoSpec{URI: "src:///head/repo"}, Rev: "headrev", CommitID: headCommit}
)
