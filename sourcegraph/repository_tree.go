...
type RepoTreeGetOptions struct {
	...
	// Contents code-formatted with HTML. This option has no effect if SourceAsJSON is set.
	Formatted bool

	// SourceAsJSON returns the source code tokenized and linked, in JSON format,
	// as an array of lines that contain information about their contents and tokens.
